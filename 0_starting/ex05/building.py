...
def count_by_condition(string: str, condition) -> int:
    ...
    condition -- a function that takes a character and returns True
...
def main():
    try:
        ...
        print(
            count_by_condition(
                string, lambda c: c.isupper()),
            "upper letters")

        print(
            count_by_condition(
                string, lambda c: c.islower()),
            "lower letters")

        print(
            count_by_condition(
                string, lambda c: c in ".,;:?!"),
            "punctuation marks")

        print(
            count_by_condition(
                string, lambda c: c.isspace()),
            "spaces")

        print(
            count_by_condition(
                string, lambda c: c.isdigit()),
            "digits"
        )
